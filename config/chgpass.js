...
module.exports.cpass = function(id,opass,npass,callback) {  
...
module.exports.respass_init = function(email,callback) {  
...
module.exports.respass_chg = function(email,code,npass,callback) {   
